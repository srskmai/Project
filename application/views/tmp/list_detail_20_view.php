          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <ul class="nav nav-pills nav-fill">
                <li class="nav-item">
                  <a class="nav-link active" href="#">1. Site by site Design Stage</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#">5. Documentation</a>
                </li>
              </ul>
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    d. Support Design Documentation
                  </div>
                  <div class="col-md-4 text-center">
                    <button type="button" class="btn btn-info btn-sm" name="button">View</button>
                      &nbsp;&nbsp;&nbsp;
